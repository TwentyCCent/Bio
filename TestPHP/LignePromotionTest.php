...
class LignePromotionTest  extends TestCase{
    ...
    function testgetPourcentageReduction(){
        ...
        $this->assertEquals("Prix du produit en promotion incorrect", $pourcentage1, "Pourcentage de reduction correct -Attendu : 48.57, obtenu : $pourcentage1");
        ...
        $this->assertEquals("Prix du produit en promotion incorrect", $pourcentage2, "Pourcentage de reduction correct -Attendu : 48.57, obtenu : $pourcentage2");
        ...
        $this->assertEquals("Prix du produit en promotion incorrect", $pourcentage3, "Pourcentage de reduction correct -Attendu : 48.57, obtenu : $pourcentage3");
